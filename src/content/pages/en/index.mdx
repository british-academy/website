...
<Section
  ...
  grid-cols="2"
>
  <Address title="Casablanca (Centre Ville)" slot="grid">
    1 Place Rue Du 16 Novembre
    {""}
    2ème Étage
    {""}
    Centre Ville
  ...
  <Address title="Casablanca (Hay Chrifa)" slot="grid">
    Rue 1{""}
    N" 41 El Hamra
    {""}
    Hay Chrifa
  ...
  <Address title="Berrechid" slot="grid">
  ...
  <Address title="El Jadida" slot="grid">
    Rue Ben Dagha
    {""}
    El Jadida 24030
  </Address>
